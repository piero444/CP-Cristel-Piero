...
public class pnlDietaConsigliata1 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lDieta.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        lDieta.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        lDieta.setMaximumSize(new java.awt.Dimension(300, 210));
        lDieta.setMinimumSize(new java.awt.Dimension(300, 210));
        lDieta.setPreferredSize(new java.awt.Dimension(300, 210));
        jPanel10.add(lDieta);

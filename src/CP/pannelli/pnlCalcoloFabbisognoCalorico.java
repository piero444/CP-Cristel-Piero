...
public class pnlCalcoloFabbisognoCalorico extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lFabbisogno = new javax.swing.JLabel();
        ...
        jLabel2.setText("Calcolo fabbisogno calorico");
        jPanel8.add(jLabel2);
        ...
        jButton4.setActionCommand("Calcola f");
        ...
        lFabbisogno.setFont(new java.awt.Font("Segoe Print", 0, 20)); // NOI18N
        lFabbisogno.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lFabbisogno.setMaximumSize(new java.awt.Dimension(280, 200));
        lFabbisogno.setMinimumSize(new java.awt.Dimension(280, 200));
        lFabbisogno.setPreferredSize(new java.awt.Dimension(280, 200));
        jPanel10.add(lFabbisogno);
